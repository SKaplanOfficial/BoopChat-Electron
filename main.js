...
$(function() {
  ...
  var BORDERCOLORS = [
    ...
    '255,200,0', '0,200,255', '66, 244, 185', '244, 65, 152',
    '23, 52, 168', '247, 178, 59', '153, 247, 59', '98, 126, 127'
  ];
  ...
  const addParticipantsMessage = (data) => {
    var message = '';
    if (data.numUsers === 1) {
      message += "one user online";
    } else {
      message += numInWords(data.numUsers) + " users online";
    }
    log(message);
  }
